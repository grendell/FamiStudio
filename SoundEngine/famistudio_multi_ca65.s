...
; [MULTI] BEGIN : We dont use this in multi-expansion.
...
; [MULTI] BEGIN : We allow multiple expansions here.
...
; [MULTI] BEGIN : We have all channels active : (2A03)+(VRC6)+(VRC7)+(FDS)+(MMC5)+(N163)+(S5B)+(EPSM optionally)
...
.endif
FAMISTUDIO_NUM_ENVELOPES        = (3+3+2+3)+(3+3+3)+(2+2+2+2+2+2)+(3)+(3+3)+(3+3+3+3+3+3+3+3)+(4+4+4)+(FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT * 4) + (FAMISTUDIO_EXP_EPSM_FM_CHN_CNT * 2)
FAMISTUDIO_NUM_PITCH_ENVELOPES  = (3)+(3)+(6)+(1)+(2)+(8)+(3)+(FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT + FAMISTUDIO_EXP_EPSM_FM_CHN_CNT)
FAMISTUDIO_NUM_CHANNELS         = (5)+(3)+(6)+(1)+(2)+(8)+(3)+(FAMISTUDIO_EXP_EPSM_CHANNELS)
...
.if FAMISTUDIO_EXP_VRC7
    FAMISTUDIO_VRC7_CH0_PITCH_ENV_IDX = 6
    FAMISTUDIO_VRC7_CH1_PITCH_ENV_IDX = 7
    FAMISTUDIO_VRC7_CH2_PITCH_ENV_IDX = 8
    FAMISTUDIO_VRC7_CH3_PITCH_ENV_IDX = 9
    FAMISTUDIO_VRC7_CH4_PITCH_ENV_IDX = 10
    FAMISTUDIO_VRC7_CH5_PITCH_ENV_IDX = 11
.endif
.if FAMISTUDIO_EXP_FDS
    FAMISTUDIO_FDS_CH0_PITCH_ENV_IDX  = 12
.endif
.if FAMISTUDIO_EXP_MMC5
    FAMISTUDIO_MMC5_CH0_PITCH_ENV_IDX = 13
    FAMISTUDIO_MMC5_CH1_PITCH_ENV_IDX = 14
.endif
.if FAMISTUDIO_EXP_N163
    FAMISTUDIO_N163_CH0_PITCH_ENV_IDX = 15
    FAMISTUDIO_N163_CH1_PITCH_ENV_IDX = 16
    FAMISTUDIO_N163_CH2_PITCH_ENV_IDX = 17
    FAMISTUDIO_N163_CH3_PITCH_ENV_IDX = 18
    FAMISTUDIO_N163_CH4_PITCH_ENV_IDX = 19
    FAMISTUDIO_N163_CH5_PITCH_ENV_IDX = 20
    FAMISTUDIO_N163_CH6_PITCH_ENV_IDX = 21
    FAMISTUDIO_N163_CH7_PITCH_ENV_IDX = 22
.endif
.if FAMISTUDIO_EXP_S5B
    FAMISTUDIO_S5B_CH0_PITCH_ENV_IDX  = 23
    FAMISTUDIO_S5B_CH1_PITCH_ENV_IDX  = 24
    FAMISTUDIO_S5B_CH2_PITCH_ENV_IDX  = 25
.endif
.if FAMISTUDIO_EXP_EPSM
    FAMISTUDIO_EPSM_CH0_PITCH_ENV_IDX = 26
    FAMISTUDIO_EPSM_CH1_PITCH_ENV_IDX = 27
    FAMISTUDIO_EPSM_CH2_PITCH_ENV_IDX = 28
    FAMISTUDIO_EPSM_CH3_PITCH_ENV_IDX = 29
    FAMISTUDIO_EPSM_CH4_PITCH_ENV_IDX = 30
    FAMISTUDIO_EPSM_CH5_PITCH_ENV_IDX = 31
    FAMISTUDIO_EPSM_CH6_PITCH_ENV_IDX = 32
    FAMISTUDIO_EPSM_CH7_PITCH_ENV_IDX = 33
    FAMISTUDIO_EPSM_CH8_PITCH_ENV_IDX = 34
.endif
; [MULTI] END
...
.endif
.if FAMISTUDIO_EXP_VRC7
    FAMISTUDIO_VRC7_CH0_ENVS = 20
    FAMISTUDIO_VRC7_CH1_ENVS = 22
    FAMISTUDIO_VRC7_CH2_ENVS = 24
    FAMISTUDIO_VRC7_CH3_ENVS = 26
    FAMISTUDIO_VRC7_CH4_ENVS = 28
    FAMISTUDIO_VRC7_CH5_ENVS = 30
.endif
.if FAMISTUDIO_EXP_FDS
...
.endif
.if FAMISTUDIO_EXP_MMC5
    FAMISTUDIO_MMC5_CH0_DUTY_IDX = 6
    FAMISTUDIO_MMC5_CH1_DUTY_IDX = 7
.endif
; [MULTI] END
...
.endif
.if FAMISTUDIO_EXP_VRC7
    FAMISTUDIO_VRC7_CH0_IDX = 8
    FAMISTUDIO_VRC7_CH1_IDX = 9
    FAMISTUDIO_VRC7_CH2_IDX = 10
    FAMISTUDIO_VRC7_CH3_IDX = 11
    FAMISTUDIO_VRC7_CH4_IDX = 12
    FAMISTUDIO_VRC7_CH5_IDX = 13
.endif
.if FAMISTUDIO_EXP_FDS
    FAMISTUDIO_FDS_CH0_IDX  = 14
.endif
.if FAMISTUDIO_EXP_MMC5
    FAMISTUDIO_MMC5_CH0_IDX = 15
    FAMISTUDIO_MMC5_CH1_IDX = 16
.else
    FAMISTUDIO_MMC5_CH0_IDX = -1
    FAMISTUDIO_MMC5_CH1_IDX = -1
.endif
.if FAMISTUDIO_EXP_N163
    FAMISTUDIO_N163_CH0_IDX = 17
    FAMISTUDIO_N163_CH1_IDX = 18
    FAMISTUDIO_N163_CH2_IDX = 19
    FAMISTUDIO_N163_CH3_IDX = 20
    FAMISTUDIO_N163_CH4_IDX = 21
    FAMISTUDIO_N163_CH5_IDX = 22
    FAMISTUDIO_N163_CH6_IDX = 23
    FAMISTUDIO_N163_CH7_IDX = 24
.endif
.if FAMISTUDIO_EXP_S5B
    FAMISTUDIO_S5B_CH0_IDX  = 25
    FAMISTUDIO_S5B_CH1_IDX  = 26
    FAMISTUDIO_S5B_CH2_IDX  = 27
.endif
.if FAMISTUDIO_EXP_EPSM
    FAMISTUDIO_EPSM_CH0_IDX = 28
    FAMISTUDIO_EPSM_CH1_IDX = 29
    FAMISTUDIO_EPSM_CH2_IDX = 30
    FAMISTUDIO_EPSM_CH3_IDX = 31
    FAMISTUDIO_EPSM_CH4_IDX = 32
    FAMISTUDIO_EPSM_CH5_IDX = 33
    FAMISTUDIO_EPSM_CH6_IDX = 34
    FAMISTUDIO_EPSM_CH7_IDX = 35
    FAMISTUDIO_EPSM_CH8_IDX = 36
    FAMISTUDIO_EPSM_CH9_IDX = 37
    FAMISTUDIO_EPSM_CH10_IDX = 38
    FAMISTUDIO_EPSM_CH11_IDX = 39
    FAMISTUDIO_EPSM_CH12_IDX = 40
    FAMISTUDIO_EPSM_CH13_IDX = 41
    FAMISTUDIO_EPSM_CH14_IDX = 42
...
FAMISTUDIO_EXP_EPSM_MASK = $40
; [MULTI] END

; [MULTI] TODO : Make the real sound engine like this.
...
; [MULTI] BEGIN : EPSM needs more RAM. We could use WRAM (6000-7fff) but its 
; kind of a shitshow to setup with FDS. This is WAYYYY easier.
.if FAMISTUDIO_EXP_EPSM
.segment "EXRAM"
.endif
; [MULTI] END
...
famistudio_dpcm_music_loop:       .res 1
.endif
...
famistudio_r2:   .res 1
famistudio_r3:   .res 1
famistudio_r4:   .res 1 ; [MULTI] Extra ZP var
...
@init_epsm:
.if FAMISTUDIO_EXP_EPSM
    ; [MULTI] BEGIN : EPSM uses MMC5 EXRAM (yes really).
    lda #2
    sta FAMISTUDIO_MMC5_EXRAM_MODE
    ; [MULTI] END
...
famistudio_music_pause:
    ...
    tax
    ; [MULTI] BEGIN : Long jump needed here when EPSM is active.
    bne @pause
    jmp @unpause
    ; [MULTI] END
...
.if FAMISTUDIO_EXP_VRC7 || FAMISTUDIO_EXP_S5B || FAMISTUDIO_EXP_FDS || FAMISTUDIO_EXP_N163 || FAMISTUDIO_EXP_EPSM
    ; [MULTI] BEGIN : Need to check more channels. Super ugly.
    cmp #FAMISTUDIO_VRC7_CH0_IDX
    bcc @duty
    cmp #FAMISTUDIO_N163_CH0_IDX
    bcs @no_duty
    cmp #FAMISTUDIO_MMC5_CH0_IDX
    bcc @no_duty
    ; [MULTI] END
.endif
@duty:
...
.if FAMISTUDIO_EXP_VRC7 || FAMISTUDIO_EXP_N163 || FAMISTUDIO_EXP_EPSM || FAMISTUDIO_EXP_S5B || FAMISTUDIO_EXP_FDS
    ...
    ; [MULTI] BEGIN : This is a mess, use a jump table maybe?
    cmp #(FAMISTUDIO_VRC6_CH2_IDX+1)
    bcc @done ; 2A03 + VRC6
    cmp #(FAMISTUDIO_VRC7_CH5_IDX+1)
    bcc @vrc7_instrument ; VRC7
    cmp #(FAMISTUDIO_FDS_CH0_IDX+1)
    bcc @fds_instrument ; FDS
    cmp #(FAMISTUDIO_MMC5_CH1_IDX+1)
    bcc @done ; MMC5 + FDS
    cmp #(FAMISTUDIO_N163_CH7_IDX+1)
    bcc @n163_instrument ; N163
    cmp #(FAMISTUDIO_S5B_CH2_IDX+1)
    bcc @s5b_instrument ; S5B
    bcs @epsm_instrument ; EPSM
    ; [MULTI] END
...
famistudio_advance_channel:
    ...
    @tmp_slide_to     = famistudio_r3 ; [MULTI] Extra variable we need.
    ...
    @note_table_ptr   = famistudio_ptr2 ; [MULTI] Extra variable we need.
...
@opcode_vrc7_release_note:
    ...
    jmp @opcode_release_note ; [MULTI] Additional jump.
.endif
...
.endif
    ...
    .if FAMISTUDIO_EXP_N163 || FAMISTUDIO_EXP_VRC7 || FAMISTUDIO_EXP_EPSM
        ; [MULTI] BEGIN : Handled a using a lookup table.
    ...
    @positive_shift:
        lda @slide_delta_lo
        sta famistudio_slide_pitch_lo,x
        ; ldy #FAMISTUDIO_PITCH_SHIFT ; [MULTI] Alread loaded above.
        @positive_shift_loop:
...
; [MULTI] BEGIN : Additionnal lookup tables to handle multiple expansions.
...
.if FAMISTUDIO_EXP_EPSM
    ...
    .byte $ff
    .byte $ff
    .byte FAMISTUDIO_EPSM_PITCH_SHIFT
    .byte FAMISTUDIO_EPSM_PITCH_SHIFT
    .byte FAMISTUDIO_EPSM_PITCH_SHIFT
    .byte FAMISTUDIO_EPSM_PITCH_SHIFT
    .byte FAMISTUDIO_EPSM_PITCH_SHIFT
...
.endif
.if FAMISTUDIO_EXP_EPSM
    .byte <famistudio_epsm_s_note_table_lsb
    .byte <famistudio_epsm_s_note_table_lsb
    .byte <famistudio_epsm_s_note_table_lsb
    .byte <famistudio_epsm_note_table_lsb
    .byte <famistudio_epsm_note_table_lsb
    .byte <famistudio_epsm_note_table_lsb
    .byte <famistudio_epsm_note_table_lsb
    .byte <famistudio_epsm_note_table_lsb
...
.endif
.if FAMISTUDIO_EXP_EPSM
    .byte <famistudio_epsm_s_note_table_msb
    .byte <famistudio_epsm_s_note_table_msb
    .byte <famistudio_epsm_s_note_table_msb
    .byte <famistudio_epsm_note_table_msb
    .byte <famistudio_epsm_note_table_msb
    .byte <famistudio_epsm_note_table_msb
    .byte <famistudio_epsm_note_table_msb
    .byte <famistudio_epsm_note_table_msb
...
.endif
; [MULTI] BEGIN : Adding the unused channels between.
.if FAMISTUDIO_EXP_VRC7
    .byte $ff ; VRC7
    .byte $ff ; VRC7
    .byte $ff ; VRC7
