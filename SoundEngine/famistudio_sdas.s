...
.endif
.if FAMISTUDIO_EXP_FDS
famistudio_chn_fds_instrument:    .ds 1
.endif
.if FAMISTUDIO_EXP_N163
...
famistudio_dpcm_music_loop:       .ds 1
.endif
...
famistudio_fds_wave_index:        .ds 1
...
FAMISTUDIO_VRC6_FREQ_CTRL = 0x41a0 ; Dummy
...
FAMISTUDIO_VRC6_FREQ_CTRL = 0x9003
...
famistudio_advance_channel_with_delays:
    ...
    cpx #4
    bne .famistudio_advance_channel_with_delays_done
    jsr famistudio_sample_stop
...
.if FAMISTUDIO_USE_VIBRATO 
    ...
    bpl .famistudio_load_basic_envelopes_no_vibrato ; In bit 7 is set, instrument pitch is overriden by vibrato, dont touch pitch envelope!
    iny
    iny
    bne .famistudio_load_basic_envelopes_done
    .famistudio_load_basic_envelopes_no_vibrato:
.endif    
    iny
    lda [*.instrument_ptr],y
    sta famistudio_pitch_env_addr_lo,x
...
famistudio_update_fds_wave:
    ...
    beq .famistudio_update_fds_wave_done
